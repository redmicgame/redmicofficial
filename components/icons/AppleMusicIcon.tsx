...
const AppleMusicIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
        <defs>
            <radialGradient id="appleMusicGradient" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="matrix(19.332 -17.352 14.331 16.095 3.328 18.23)">
                <stop offset="0" stopColor="#fa5267" />
                <stop offset=".5" stopColor="#f72e8f" />
                <stop offset="1" stopColor="#a336f3" />
            </radialGradient>
        </defs>
        <rect width="24" height="24" rx="5" fill="url(#appleMusicGradient)" />
