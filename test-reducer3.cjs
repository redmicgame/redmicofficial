...
try {
  ...
  console.log("Original:", initialState.artistsData.artist1.tours[0].setlist);
  console.log("Next:", nextState.artistsData.artist1.tours[0].setlist);
  console.log("Posts:", nextState.artistsData.artist1.xPosts);
} catch (e) {
